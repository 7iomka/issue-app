import type { PasswordInputProps as NativePasswordInputProps } from '@mantine/core';
import { useComponentDefaultProps, PasswordInput as NativePasswordInput } from '@mantine/core';
...
interface PasswordInputProps extends Omit<NativePasswordInputProps, 'onChange'> {
...
const PasswordInput = createView<PasswordInputProps>()
