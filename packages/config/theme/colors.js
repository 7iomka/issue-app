...
const colorPalette = {
  ...
  gray: {
    // fill for badges (numeric)
    50: '#fafafa',
    // for inputs fill, etc
    100: '#f4f4f4',
    // fill for progressbars, for some button groups
    200: '#f3f3f3',
    // fill for checkboxes, radios
    300: '#efefef',
    // border for default input
    400: '#e5e5e5',
    // close buttons fill in forms
    500: '#dddddd',
    // text color in currently active/inactive items
    600: '#a1a1a1',
    // borders for some inputs
    700: '#808080',
    // text color in currently active/inactive items / overlays
    800: '#757575',
    // text color in currently active/inactive items / overlays
    900: '#6b6b6b',
  },
...
const themeColorKeys = ['primary', 'secondary', 'success', 'danger'];

module.exports = { colors, themeColorKeys };
